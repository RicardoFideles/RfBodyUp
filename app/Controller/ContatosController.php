...
class ContatosController extends AppController {
  ...
  public function enviar() {
	...
	public function email ()  {
		...
		$emailsender = "ricardo@ricardofideles.com.br";
				
		if(PHP_OS == "Linux") $quebra_linha = "\n"; //Se for Linux
		elseif(PHP_OS == "WINNT") $quebra_linha = "\r\n";
		
		$nomeremetente = "Contato da Loja BodyUp";
		$emailremetente = "ricardo@ricardofideles.com.br";
		$emaildestinatario = "ricardo@ricardofideles.com.br";
