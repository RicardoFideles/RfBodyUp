	...
	<div class="container">
		...
		<div class="col-lg-2 col-md-3 col-sm-3 col-xs-2 text-right">
			<a href="http://www.alexandre-rocha.com" target="_blank">
				<img src="<?php echo $this->Html->url('/imagens/LogoAlexandreRocha.png'); ?> " class="LogoARcom hidden-xs" />
				<img src="<?php echo $this->Html->url('/imagens/LogoAlexandreRocha_icon.png'); ?>" class="LogoARcom visible-xs" />
			</a>
		</div>
	</div>
</div>