...
$tinybrowser['path']['image'] = '/RfBodyUp/app/webroot/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/RfBodyUp/app/webroot/uploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/RfBodyUp/app/webroot/uploads/files/'; // Other files location
