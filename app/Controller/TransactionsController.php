 ...
 */
	public function add() {
		...
		if ($this->request->is('post')) {
			...
			//Testar manipulacao de dados, inserindo o qtd vinculado a cada produto, pois será necessário guarda o preco e valor da transacao
			
			
			//Estudar possibilidade de persistir um json com request na tabela tbm.
